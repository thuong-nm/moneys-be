...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is used to authenticate external API requests.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Absolute path to the FFmpeg binary. Required for video merge operations.
    |
    */

    'ffmpeg_path' => env('FFMPEG_PATH', '/home/thuongnm/bin/ffmpeg'),
